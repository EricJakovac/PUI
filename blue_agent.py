...
from movement2 import BlueMovement
...
class Agent:
    ...
    def __init__(self, color, index):
        ...
        self.stuck_count = 0
        self.movement = BlueMovement(color)
    ...
    def update(self, visible_world, position, can_shoot, holding_flag):
        ...
        if self.index == 0:  # 1st agent moves normally
            ...
            if self.has_flag:
                ...
                if self.prev_direction == "right" and random.random() < 0.9:  # 90% chance of continuing to move right
                    direction = "right"
                elif self.prev_direction == "right" and random.random() < 0.1:  # 10% chance of moving up or down
                ...
                x = position[0]
                y = position[1]
                if   direction == "left" and x + 1 >= len(visible_world[0]):
                    direction = "right"
                elif direction == "right" and x - 1 < 0:
                    direction = "left"
